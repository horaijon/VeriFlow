...
const BACKGROUND = "#09090b"; // zinc-950 to match theme
...
<body class="antialiased min-h-screen flex flex-col relative overflow-x-hidden bg-[#09090b] text-white selection:bg-[#2640D9]/40 selection:text-white" style="font-family: 'Inter', sans-serif;">
    ...
    <script>
        ...
        const fragmentShader = \`
            ...
            void main() {
                ...
                vec3 baseColor = vec3(0.035, 0.035, 0.043); // zinc-950 base
                vec2 st = uv * 0.7;
                ...
                vec3 glow = mix(vec3(0.023, 0.713, 0.831), vec3(0.231, 0.509, 0.964), snoise(uv * 1.5 + u_time * 0.1) * 0.5 + 0.5); // Cyan to Blue glow
