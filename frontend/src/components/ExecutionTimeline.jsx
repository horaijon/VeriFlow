  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {isProcessing && (
          <span className="ml-2 text-[10px] font-medium text-blue-400 animate-pulse">
            ● RUNNING
          </span>
        )}
      </div>
        ...
        {isProcessing && !result && (
          <div className="flex flex-col items-center justify-center h-[400px]">
            <div className="relative">
              <div className="w-12 h-12 rounded-full border-2 border-zinc-800 border-t-blue-500 animate-spin-slow" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-4 h-4 rounded-full bg-blue-500/20" />
              </div>
            </div>
            <p className="mt-4 text-sm text-blue-400 font-medium animate-pulse">
              Agent processing...
            </p>
          ...
          <div className="p-6">
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-red-500">Connection Error</span>
              </div>
              ...
              >
                {result.status === 'resolved' && (
                  <div className="mb-4 relative">
                    <div className="absolute left-[19px] top-[-24px] bottom-full w-px bg-emerald-500/50" />
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-zinc-950 border-2 border-emerald-500/30 flex items-center justify-center shrink-0 z-10">
